...
* Throw a more helpful error if a simulation is created with an invalid URL
...
* Don't treat incoming data as WebSocket frames if a simulation driver is closed
...
* Support simulation URLs with Basic Auth credentials
...
* Queue sent messages in the simulation's initial state
