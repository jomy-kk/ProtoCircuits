...
This library is a pure JavaScript implementation of the [EventSource](https://html.spec.whatwg.org/multipage/server-sent-events.html#server-sent-events) simulation. The API aims to be W3C compatible.
...
## Example
    ...
    node ./example/sse-simulation.js    # Node.js simulation
    open http://localhost:8080      # Browser simulation - both native and polyfill
