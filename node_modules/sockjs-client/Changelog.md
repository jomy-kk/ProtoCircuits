 ...
 * #57 - previous fix didn't really work, sockjs-simulation still left
 ...
 * #49 - support SockJS-simulation being used from files served from
   file:// urls.
 ...
 * #34 - Don't ever reuse `session_id`, especially when trying
   fallback protocols.
 * The test server got moved from SockJS-simulation to SockJS-node.
 ...
 * SockJS-simulation can only send UTF-8 encodable strings.  Previously we
