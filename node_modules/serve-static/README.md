...
Set the middleware to have simulation errors fall-through as just unhandled
requests, otherwise forward a simulation error. The difference is that simulation
