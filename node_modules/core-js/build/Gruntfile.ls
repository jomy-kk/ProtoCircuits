...
module.exports = (grunt)->
  ...
  grunt.initConfig do
    ...
    karma:
      'options':
        ...
        singleRun: on
      'default': {}
      'library': files: <[simulation/library.js tests/helpers.js tests/library.js]>map -> src: it
  ...
  grunt.registerTask \default <[clean copy simulation library shim]>